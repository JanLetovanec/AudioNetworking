...
public class DPSKDemodulator extends FixedBatchDemodulator {
    ...
    public DPSKDemodulator(double frequency, int cyclesPerBit, long sampleRate) {
        super(getBatchSize(frequency, cyclesPerBit), sampleRate);
        this.frequency = frequency;
        this.sampleRate = sampleRate;
    }

    public DPSKDemodulator(long sampleRate) {
