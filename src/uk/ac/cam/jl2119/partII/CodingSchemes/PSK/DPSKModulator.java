...
public class DPSKModulator extends FixedBatchModulator {
    ...
    public DPSKModulator(long sampleRate) {
        super(getBatchSize(DEFAULT_FREQUENCY, DEFAULT_CYCLES_PER_BIT), sampleRate);
        this.frequency = DEFAULT_FREQUENCY;
    }

    public DPSKModulator(double frequency, int cyclesPerBit, long sampleRate) {
