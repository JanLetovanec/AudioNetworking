package uk.ac.cam.jl2119.partII.ReedSolomon;
...
public class FiniteFieldElement {
    ...
    // GENERATOR = 3
    // PRIME_POLYNOMIAL = 0x11b
    // taken from:
    // https://github.com/lrq3000/unireedsolomon/blob/887dd2ce49a7ebd81e94b6032d08888629ea577a/unireedsolomon/ff.py#L163
    private static final long[] expLookup = new long[]{
    ...
    // Same as before
    // BEWARE: log(0) does not exist
    private static final long[] logLookup = new long[]{
            -1, 0, 25, 1, 50, 2, 26, 198, 75, 199, 27, 104, 51, 238, 223,
    ...
    public FiniteFieldElement(Byte x) {
        currentValue = (int)(x & GF_CHARACTERISTIC);    // treat the byte as unsigned
    }

    public FiniteFieldElement(FiniteFieldElement element) {
        currentValue = element.currentValue;
    }

    public static FiniteFieldElement getOne() {
        return new FiniteFieldElement((byte)1);
    }
    ...
    public FiniteFieldElement add(FiniteFieldElement second) {
        return new FiniteFieldElement((byte) (currentValue ^ second.currentValue));
    }
